...
const Hero = () => {
  return (
    <div className="relative isolate">
      ...
      <div className="container flex flex-col space-y-3 justify-center aspect-video min-h-[70vh] max-h-[72vh] mx-auto bg-cover z-20 bg-center bg-no-repeat px-4 lg:px-16 py-12">
