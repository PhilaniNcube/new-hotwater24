					...
					<div className="items-center justify-between md:flex">
						<div className="xl:w-6/12 md:w-1/2 xl:pr-8 md:pr-4">
							...
							>
								...
								installation business, we understand your need. Either when it
								is a need for comfort{" "}
								<span className="font-bold">
									{" "}
									(on demand hot water 24/7 for your family)
								</span>{" "}
								or a need out of necessity (tired of load shedding, cold water
								and high energy bills from Eskom) and want to become
								“off-the-grid” and independent from Eskom and save money on your
								monthly energy bill at the same time! Then heating up your water
								with a gas heating solution is the answer!
							</p>
