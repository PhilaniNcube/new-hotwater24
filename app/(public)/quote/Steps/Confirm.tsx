					...
					<div className="flex items-center p-8 bg-gray-100 lg:w-1/2 lg:ml-12 lg:p-14">
						<div>
							...
							<p className="mt-5 text-base leading-normal text-gray-600 md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12">
								Thank you for completing the questions. Based on the information
								provided we will send you our proposal and contact you
								accordingly to discuss your requirements and take you through
								the next steps.
							</p>
							<p className="mt-5 text-base leading-normal text-gray-600 md:w-9/12 lg:w-11/12 xl:w-10/12 2xl:9/12">
								If you did not receive the confirmation e-mail, please check
								your spam folder.
							</p>
						</div>
					</div>
