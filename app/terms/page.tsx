const TermsPage = () => {
  return (
    <div className="max-w-6xl px-8 mx-auto py-20">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Delivery Policy</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Return and Refunds policy</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Customer Privacy policy</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Payment options accepted</h2>
      <p className="text-md">Payment may be made via Visa and MasterCard.</p>
      <h2 className="text-lg font-semibold mb-2 mt-4">Card acquiring and security</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Customer details separate from card details</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Responsibility</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Country of domicile</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Variation</h2>
      <p className="text-md">
        Hotwater24 may, in its sole discretion, change this agreement or any
        part thereof at any time without notice.
      </p>
      <h2 className="text-lg font-semibold mb-2 mt-4">Company information</h2>
      <p className="text-md">
      ...
      <h2 className="text-lg font-semibold mb-2 mt-4">Hotwater24 contact details </h2>
      <p className="text-md">
