...
const TermsPage = () => {
  return (
    <div className="max-w-6xl px-8 py-20 mx-auto">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Delivery Policy</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Return and Refunds policy</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Customer Privacy policy</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Payment options accepted</h2>
      <p className="text-md">Payment may be made via Visa and MasterCard.</p>
      <h2 className="mt-4 mb-2 text-lg font-semibold">Card acquiring and security</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Customer details separate from card details</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Responsibility</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Country of domicile</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Variation</h2>
      <p className="text-md">
        Hotwater24 may, in its sole discretion, change this agreement or any
        part thereof at any time without notice.
      </p>
      <h2 className="mt-4 mb-2 text-lg font-semibold">Company information</h2>
      <p className="text-md">
      ...
      <h2 className="mt-4 mb-2 text-lg font-semibold">Hotwater24 contact details </h2>
      <p className="text-md">
